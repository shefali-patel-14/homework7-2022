...
function slowDownVideo() {
  ...
  console.log(vid.playbackRate.toFixed(5));
}
...
function slowDownVideo()  {
  ...
  slowDownCount++;
  console.log(`New speed: ${vid.playbackRate.toFixed(2)}`);
};
...
function speedUpVideo() {
  if (slowDownCount > 0) {
    const speedIncrease = 1 + (0.05 * slowDownCount);
    vid.playbackRate *= speedIncrease;
    slowDownCount--;
    console.log(`New speed: ${vid.playbackRate.toFixed(2)}`);
  }
};
